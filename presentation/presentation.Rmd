...
#Shape files for leaflet maps
download.file("http://thematicmapping.org/downloads/TM_WORLD_BORDERS_SIMPL-0.3.zip" , destfile="/cloud/project/data/world_shape_file.zip")
system("unzip /cloud/project/data/world_shape_file.zip")
