...
.center[
```{r fossil-fuel-consumption-plot, out.width="100%", fig.width=2.5, echo=FALSE, message=FALSE, warning=FALSE, fig.alt= "The visualization shows that fossil fuel consumption has increased rapidly in the past 30 years while the United States consumed fossil fuels at a steady rate." }
