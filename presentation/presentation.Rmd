...
.pull-right[
```{r climatechange, echo = FALSE, out.width = "80%", fig.align= "right", fig.cap = "The Caldor fire in Eldorado National Forest near Pollock Pines, Calif., last year. [2]" }
...
.center[
```{r China-USA-fossil-plot, echo = FALSE, message = FALSE, warning = FALSE}
...
q
```
- Why haven't other countries beyond Europe produced the carbon emissions? 
- How do policies surrounding emissions impact available data? 
---
...
```{r solar-consumption-all-plot, fig.align = 'center', fig.alt= "Line graph of solar consumption per country per year. ", echo = FALSE, message = FALSE, warning = FALSE}
...
```{r solar-consumption-per-capita-all-plot, fig.align= 'center',  fig.alt= "Line graph of solar consumption per capita per country per year. "}
