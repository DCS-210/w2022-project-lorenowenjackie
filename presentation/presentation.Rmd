...
```{r wind-consumption-all_countries-plot, echo=FALSE, out.width = "60%", out.height = "60%", message=FALSE, warning=FALSE}
...
wind_consumption_graph
```
---
###Leaders in Wind: Per Capita
```{r wind-consumption-per-capita-all_countries-plot, out.width = "60%", out.height = "60%", echo = FALSE, warning = F, message = F, fig.alt= "Line graph of wind consumption per capita per country per year."}
